  ...
  return (
    <div className="container-xxl flex-grow-1 container-p-y">
      ...
      <div className="card">
        ...
        >
          <h5>Current Casino Bets</h5>
          <div className="d-inline-block mr-2">
            <DownloadTableExcel
              filename="Current Casino Bets"
              sheet="Current Casino Bets"
            ...
            <button
              title="Export To PDF"
              onClick={() =>
                exportPdf("#current-casino-bets", "current-casino-bets.pdf")
              }
              type="button"
...
export default CurrentCasinoBets;
